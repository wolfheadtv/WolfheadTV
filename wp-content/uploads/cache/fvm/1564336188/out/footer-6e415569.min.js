...
var tic=document.createElement('div');tic.setAttribute('id','tic');document.querySelector('#content .menu').appendChild(tic);tic.innerHTML('<div></div>');let menu=document.querySelectorAll('#content .menu');if(menu){let menu_slider_hover=document.getElementById('tic');if(menu_slider_hover){nav_slider(menu[0],function(el,width,tempMarginLeft){el.onmouseover=()=>{menu_slider_hover.style.width=width+'%';menu_slider_hover.style.marginLeft=tempMarginLeft+'%'}})}
let menu_slider_click=document.querySelector('.current_page_item');if(menu_slider_click){nav_slider(menu[1],function(el,width,tempMarginLeft){el.onclick=()=>{menu_slider_click.style.width=width+'%';menu_slider_click.style.marginLeft=tempMarginLeft+'%'}})}}
...
callback(el,width,tempMarginLeft);marginLeft.push(width)})}}
