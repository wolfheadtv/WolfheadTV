...
var tic=document.createElement('div');tic.setAttribute('id','tic');document.querySelector('#content .menu').appendChild(tic);tic.innerHTML='<div></div>';function ready(fn){if(document.attachEvent?document.readyState==="complete":document.readyState!=="loading"){fn()}else{document.addEventListener('DOMContentLoaded',fn)}};function setupNav(){var wee=document.querySelector('#tic').style,navList=document.querySelectorAll('#content .menu > li'),currentNav=document.querySelector('.current_page_item');navList.forEach(function(nav){nav.addEventListener('mouseover',function(){wee.left=this.offsetLeft-currentNav.offsetLeft+'px';wee.width=this.offsetWidth+'px'});nav.addEventListener('mouseout',function(){wee.left='0';wee.width=currentNav.offsetWidth+'px'})})};ready(function(){setupNav()});document.querySelector('#content .menu > li.current_page_item').focus();document.querySelector('#content .menu > li.current_page_item').blur();
