...
if(menu_slider_hover){nav_slider_return(menu[0],function(el,width,tempMarginLeft,index){el.onmouseout=()=>{menu_slider_hover.style.width=width+'%';menu_slider_hover.style.marginLeft=tempMarginLeft+'%';menu_slider_hover.setAttribute('data-index',index)}})}
