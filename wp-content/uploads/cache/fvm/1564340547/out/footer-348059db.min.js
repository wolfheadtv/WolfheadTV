...
var tic=document.createElement('div');tic.setAttribute('id','tic');document.querySelector('#content .menu li.current_page_item').appendChild(tic);tic.innerHTML='<div></div>';function ready(fn){if(document.attachEvent?document.readyState==="complete":document.readyState!=="loading"){fn()}else{document.addEventListener('DOMContentLoaded',fn)}};function setupNav(){var wee=document.querySelector('#tic').style,navList=document.querySelectorAll('#content .menu > li'),currentNav=document.querySelector('.current_page_item');navList.forEach(function(nav,index){nav.addEventListener('mouseover',function(){wee.left=this.offsetLeft-currentNav.offsetLeft+'px';wee.width=this.offsetWidth+'px';document.querySelector('#tic').setAttribute('data-index',index)});nav.addEventListener('mouseout',function(){wee.left='0';wee.width=currentNav.offsetWidth+'px';var index2=navList.findIndex(function(currentNav){return currentNav.classList.contains('current_page_item')}
document.querySelector('#tic').setAttribute('data-index',index2)})})};ready(function(){setupNav()});
