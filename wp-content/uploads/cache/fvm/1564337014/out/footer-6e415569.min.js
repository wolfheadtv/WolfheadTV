...
/*! smooth-scroll v15.2.1 | (c) 2019 Chris Ferdinandi | MIT License | https://github.com/cferdinandi/smooth-scroll */
...
var menuItems=document.querySelectorAll('.site-header ul > li.--parent > a:nth-child(1)');window.addEventListener("scroll",function(){var shadowHandler=document.querySelector('.site-header > .top');if(window.scrollY>(shadowHandler.offsetTop+shadowHandler.offsetHeight)){shadowHandler.classList.add('--shadow')}else{shadowHandler.classList.remove('--shadow')}
if(document.querySelector('.--scrollhandler')){document.querySelector('.site-header > .top').classList.add('--titled');var scrollHandler=document.querySelector('.--scrollhandler').getBoundingClientRect();if(window.scrollY>(scrollHandler.bottom+window.pageYOffset)-36){document.querySelector('.site-header > .top').classList.add('--scrolled')}else{document.querySelector('.site-header > .top').classList.remove('--scrolled')}}else{if(window.scrollY>500){document.querySelector('.site-header > .top').classList.add('--scrolled')}else{document.querySelector('.site-header > .top').classList.remove('--scrolled')}}
for(var i=0;i<menuItems.length;i++){menuItems[i].closest("li.--parent").classList.remove('--open')}});for(var i=0;i<menuItems.length;i++){menuItems[i].addEventListener('click',function(e){this.closest("li.--parent").classList.add('--open');hideOnClickOutside(this.closest("li.--parent"),"--open",0);e.preventDefault()})}
document.querySelector('li.about > a').addEventListener('mouseover',function(e){if(document.querySelector('#about').classList.contains('--open')===!1){document.querySelector('#about').classList.add('--tease')}
if(document.querySelector('#about').classList.contains('--loaded')===!1){document.querySelector('#about').innerHTML='<iframe src="/about-me"></iframe>'}
document.querySelector('#about').classList.add('--loaded')});document.querySelector('li.about > a').addEventListener('mouseout',function(e){if(document.querySelector('#about').classList.contains('--open')===!1){document.querySelector('#about').classList.remove('--tease')}});document.querySelector('li.about > a').addEventListener('click',function(e){var contentFrame=document.querySelector('#about iframe').contentDocument||document.querySelector('#about iframe').contentWindow.document;if(document.querySelector('li.about').classList.contains('--open')){document.querySelector('li.about > a')._tippy.setContent('About Me');document.querySelector('body').classList.remove('--about-me-open');document.querySelector('li.about').classList.remove('--open');document.querySelector('#about').classList.remove('--open');contentFrame.querySelector('#content').classList.remove('--open')}else{document.querySelector('li.about > a')._tippy.setContent('Close');document.querySelector('body').classList.add('--about-me-open');document.querySelector('li.about').classList.add('--open');document.querySelector('#about').classList.add('--open');contentFrame.querySelector('#content').classList.add('--open')}
e.preventDefault()});function hideOnClickOutside(element,classes,timeout){const outsideClickListener=event=>{if(!element.contains(event.target)){if(isVisible(element)){setTimeout(function(){element.classList.remove(classes);removeClickListener()},timeout)}}}
const removeClickListener=()=>{document.removeEventListener('click',outsideClickListener)}
document.addEventListener('click',outsideClickListener)
return!1}
const isVisible=elem=>!!elem&&!!(elem.offsetWidth||elem.offsetHeight||elem.getClientRects().length);new SmoothScroll('a[href^="#"]',{speed:500,speedAsDuration:!0,easing:'easeInOutCubic'});function sharePost(e){e.classList.contains("share-tumblr")||e.classList.contains("share-facebook")?PopupCenter(e.getAttribute("href"),"share-dialog","558","749"):e.classList.contains("share-reddit")?PopupCenter(e.getAttribute("href"),"share-dialog","900","749"):PopupCenter(e.getAttribute("href"),"share-dialog","626","420")}
function PopupCenter(e,n,t,i){var o=null!=window.screenLeft?window.screenLeft:window.screenX,c=null!=window.screenTop?window.screenTop:window.screenY,r=window.innerWidth?window.innerWidth:document.documentElement.clientWidth?document.documentElement.clientWidth:screen.width,d=window.innerHeight?window.innerHeight:document.documentElement.clientHeight?document.documentElement.clientHeight:screen.height,s=r/window.screen.availWidth,l=(r-t)/2/s+o,w=(d-i)/2/s+c,h=window.open(e,n,"scrollbars=yes, width="+t/s+", height="+i/s+", top="+w+", left="+l);window.focus&&h.focus()};
var searchToggleOff;addDynamicEventListener(document.body,'click','li.search > a',function(e){if(document.querySelector('li.search').classList.contains('--open')){if(document.querySelector('li.search').classList.contains('--noresults')){document.querySelector('li.search input').focus()}else{if(document.querySelector('li.search input').value.length>2){window.location='/search?q='+document.querySelector('li.search input').value}else if(document.querySelector('li.search input').value.length<3&&document.querySelector('li.search input').value!==''){document.querySelector('li.search input').focus()}else{document.querySelector('li.search input').blur();document.querySelector('li.search').classList.remove('--open')}}}else{document.querySelector('li.search input').focus();var val=document.querySelector('li.search input').value;document.querySelector('li.search input').value='';document.querySelector('li.search input').value=val}
e.preventDefault();clearTimeout(searchToggleOff)});document.querySelector('li.search input').addEventListener('focus',function(e){document.querySelector('li.search').classList.add("--open");e.preventDefault()});document.querySelector('li.search input').addEventListener('blur',function(e){if(document.querySelector('li.search input').value===''){searchToggleOff=setTimeout(function(){document.querySelector('li.search').classList.remove("--open")},1000)}
e.preventDefault()});document.querySelector('li.search input').addEventListener('keydown',function(e){if((document.querySelector('li.search input').value.length<3&&e.keyCode===13)||(document.querySelector('li.search').classList.contains('--noresults')&&e.keyCode===13)){e.preventDefault();return!1}});
tippy('.site-header>.top .logo a:nth-child(2)',{animation:'fade',duration:500,arrow:!0,distance:0,followCursor:'horizontal',placement:'bottom',size:'small',theme:'top lite',sticky:!0});tippy('.site-header .center ul > li > a[data-tippy-content]:not([data-tippy-content=""])',{animation:'fade',duration:500,arrow:!0,distance:0,followCursor:'horizontal',placement:'bottom',size:'small',theme:'top lite',sticky:!0});tippy('.site-header .right ul > li:not([class]) > a[data-tippy-content]:not([data-tippy-content=""])',{animation:'fade',duration:500,arrow:!0,distance:0,followCursor:'horizontal',placement:'bottom',size:'small',theme:'top lite',sticky:!0});tippy('.site-header .right ul > li[class]:not(.about) > a[data-tippy-content]:not([data-tippy-content=""])',{animation:'fade',duration:500,arrow:!0,distance:0,followCursor:'horizontal',placement:'bottom',size:'small',theme:'top lite',delay:[3000,0],sticky:!0});tippy('.site-header .right ul > li.about > a',{animation:'fade',duration:500,arrow:!0,distance:0,followCursor:'horizontal',placement:'bottom',size:'small',theme:'top lite',sticky:!0});tippy('.img[data-tippy-content]:not([data-tippy-content=""])',{animation:'fade',duration:500,distance:4,followCursor:!0,size:'small',theme:'lite'});if(document.querySelector('section.no-results.not-found')){tippy('li.search.--open > input',{animation:'fade',duration:500,arrow:!0,distance:0,followCursor:!1,size:'small',theme:'top lite',allowHTML:!0,hideOnClick:!1,content:'Your search for <strong>'+urlParams.get('q')+'</strong> returned 0 results',delay:[0,999999999],sticky:!0});var urlParams=new URLSearchParams(window.location.search);const searchTippy=document.querySelector('li.search.--open > input')._tippy;setTimeout(function(){searchTippy.show()},1000);document.querySelector('li.search > input').addEventListener('focus',function(e){searchTippy.hide();setTimeout(function(){searchTippy.destroy()},1000)})}
if(document.querySelector('.post.--list-item .footer .share a')){tippy('.post.--list-item .footer .share a:not(.shortlink)',{animation:'fade',duration:500,arrow:!0,distance:8,placement:'top-start',followCursor:'horizontal',flip:!0,size:'small',theme:'lite'});tippy('.post.--list-item .footer .share a.shortlink',{animation:'fade',duration:500,arrow:!0,distance:8,placement:'top-start',flip:!0,size:'small',theme:'lite shortlink',hideOnClick:!1,content:'Click to copy'});var shortlinkTimeout;const shortlinkTippy=document.querySelector('.post.--list-item .footer .share a.shortlink')._tippy;document.querySelector('.post.--list-item .footer .share a.shortlink').addEventListener('click',function(e){shortlinkTippy.setContent('Copied!');shortlinkTippy.set({delay:[0,1000]});shortlinkTimeout=setTimeout(function(){shortlinkTippy.set({delay:0})},1000);e.preventDefault();return document.getElementById("shortlink_field").select(),document.execCommand("copy"),!1});document.querySelector('.post.--list-item .footer .share a.shortlink').addEventListener('mouseenter',function(e){clearTimeout(shortlinkTimeout);shortlinkTippy.setContent('Click to copy');shortlinkTippy.show();e.preventDefault()});document.querySelector('.post.--list-item .footer .share a.shortlink').addEventListener('mouseout',function(e){clearTimeout(shortlinkTimeout);shortlinkTippy.hide();e.preventDefault()})};
var tic=document.createElement('div');tic.setAttribute('id','tic');document.querySelector('#content .menu').appendChild(tic);tic.innerHTML='<div></div>';let menu=document.querySelectorAll('#content .menu');if(menu){let menu_slider_hover=document.getElementById('tic');if(menu_slider_hover){nav_slider(menu[0],function(el,width,tempMarginLeft,index){el.onmouseover=()=>{menu_slider_hover.style.width=width+'%';menu_slider_hover.style.marginLeft=tempMarginLeft+'%';menu_slider_hover.setAttribute('data-index',index)}})}
if(menu_slider_hover){nav_slider_return(menu[0],function(el,width,tempMarginLeft,index){el.onmouseexit=()=>{menu_slider_hover.style.width=width+'%';menu_slider_hover.style.marginLeft=tempMarginLeft+'%';menu_slider_hover.setAttribute('data-index',index)}})}
let menu_slider_click=document.querySelector('.current_page_item');if(menu_slider_click){nav_slider(menu[1],function(el,width,tempMarginLeft,index){el.onclick=()=>{menu_slider_click.style.width=width+'%';menu_slider_click.style.marginLeft=tempMarginLeft+'%';menu_slider_hover.setAttribute('data-index',index)}})}}
function nav_slider(menu,callback){let menu_width=menu.offsetWidth;menu=menu.getElementsByTagName('li');if(menu.length>0){var marginLeft=[];[].forEach.call(menu,(el,index)=>{var width=getPercentage(el.offsetWidth,menu_width);var tempMarginLeft=0;if(index!=0){tempMarginLeft=getArraySum(marginLeft)}
callback(el,width,tempMarginLeft,index);marginLeft.push(width)})}}
function nav_slider_return(menu,callback){let menu_width=menu.offsetWidth;menu=menu.querySelector('li.current_page_item');if(menu.length>0){var marginLeft=[];[].forEach.call(menu,(el,index)=>{var width=getPercentage(el.offsetWidth,menu_width);var tempMarginLeft=0;if(index!=0){tempMarginLeft=getArraySum(marginLeft)}
callback(el,width,tempMarginLeft,index);marginLeft.push(width)})}}
function getPercentage(min,max){return min/max*100}
function getArraySum(arr){let sum=0;[].forEach.call(arr,(el,index)=>{sum+=el});return sum}
document.querySelector('#content .menu li.current_page_item').click();
...
jQuery(document).ready(function($){liveSearch=function(searchObject){var searchQuery=searchObject.val();$.ajax({type:'POST',url:ajaxurl,data:{action:'harris_live_search',query:searchQuery,referrer:window.location.href},success:function(data){if(searchQuery.length>2){if(data=='error'){searchObject.parent().find('.dropdown').removeClass('--loaded');searchObject.parent().removeClass('--noresults')}else if(data=='nocontent'){searchObject.parent().find('.dropdown').removeClass('--loaded');searchObject.parent().addClass('--noresults')}else{searchObject.parent().removeClass('--noresults');if(searchObject.parent().find('.dropdown')){searchObject.parent().find('.dropdown').addClass('--loaded');searchObject.parent().find('.dropdown').html(data)}else{searchObject.append('<ul class="dropdown --loaded"></ul>');searchObject.parent().find('.dropdown').append(data)}}}else{$('li.search > ul.dropdown').removeClass('--loaded')}},error:function(data){}})}
var loadTimer;$('body').on('keyup','li.search > input',function(e){if(e.keyCode!==13){liveSearch($(this))}});$('body').on('blur','li.search > input',function(){loadTimer=setTimeout(function(){$('li.search > ul.dropdown').removeClass('--loaded')},1000)});$('body').on('focus','li.search > input',function(){if($(this).val().length>2){$('li.search > ul.dropdown').addClass('--loaded')}});$('body').on('click','li.search > ul.dropdown',function(){$('li.search > input').focus();clearTimeout(loadTimer)})});
jQuery(document).ready(function($){imageCredit=function(imageID,loaded=!1,obj,link=!1){$.ajax({type:'POST',url:ajaxurl,dataType:'JSON',data:{action:'harris_image_credit',id:imageID,referrer:window.location.href},success:function(data){if(loaded===!1){tippy(obj.get(),{animation:'fade',duration:500,arrow:!0,distance:8,followCursor:!1,size:'small',theme:'lite',placement:'left',allowHTML:!0,content:data.title+' by '+data.artist,showOnInit:!0})}
if(link){$(obj).attr({href:data.source,target:'_blank'})}},error:function(data){if(loaded===!1){tippy(obj,{animation:'fade',duration:500,arrow:!0,distance:8,followCursor:!1,size:'small',theme:'lite',placement:'left',allowHTML:!0,content:'Error',showOnInit:!0})}}})}
$('i.credit').each(function(){var loaded=!1;$(this).hover(function(){imageCredit($(this).data('thumb'),loaded,$(this));if(loaded===!1)loaded=!0})});$('a.credit').each(function(){var loaded=!1;$(this).hover(function(){imageCredit($(this).data('thumb'),loaded,$(this),!0);if(loaded===!1)loaded=!0})})});
